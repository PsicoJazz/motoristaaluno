          ...
          <div class="card">
            ...
            <div class="card-body">
              <table class="table table-bordered table-striped">
                ...
                <tr>
                  <td><?= isset($usuario['id']) ? $usuario['id'] : 'N/A' ?></td>
                  <td><?= isset($usuario['nome']) ? $usuario['nome'] : 'N/A' ?></td>
                  <td><?= isset($usuario['rota']) ? $usuario['rota'] : 'N/A' ?></td>
                  <td><?= isset($usuario['celular']) ? $usuario['celular'] : 'N/A' ?></td>
                  <td>
